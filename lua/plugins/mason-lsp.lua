return  {
  ...
  -- dependencies = {
    ...
    -- parse nvim-lspconfig (client) to mason. Mason will use it to install lsp servers and configure them.
    -- 'mason-org/mason-lspconfig.nvim',
    -- check and update the installed lsp servers
  ...
  config = function()
    ...
    vim.list_extend(ensure_installed, {
      ...
      'prettierd', -- Used to format json, yaml and others
      'terraform', -- Used to format terraform code
